...
export const Card = ({
  ...
  return (
      <div 
        ...
        className="flex justify-between items-center rounded-lg bg-slate-600 text-white pl-3 p-2 text-[14px] cursor-pointer hover:outline-1 hover:outline-slate-400 hover:outline"
      >
